...
cl /nologo /c /DMEM_COPY=memcpy /DMEM_MOVE=memmove /DMEM_COMPARE=memcmp /DMEM_SET=memset /DDEBUG jszl.c
::cl  jszl.i
::cl /Fotest\test.obj /Fetest\test.exe test\test.c /link dictionary.obj ini.obj atom.obj fmap.obj registry.obj
cl /nologo /Fotest\test.obj /FI"..\..\core.h" /Fe"test\test.exe" /DDEBUG test\test.c /link /MACHINE:x86 jszl.obj
